...
object Utils {
  ...
  val trainParser = new OptionParser[TrainParams]("BigDL ResNet") {
    head("Train ResNet model")
    opt[String]("appName")
    ...
    opt[Int]("maxIteration")
      .text("number of iteration of ResNet; default is 100000")
  ...
  val testParser = new OptionParser[TestParams]("BigDL ResNet Test Example") {
    opt[String]('f', "folder")
